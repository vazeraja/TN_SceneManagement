// Credit: https://github.com/azixMcAze/Unity-SerializableDictionary/blob/master
...
namespace ThunderNut.SceneManagement.Editor {
    ...
    public class SerializableDictionaryPropertyDrawer : PropertyDrawer {
        ...
        static float DrawKeyValueLineSimple(SerializedProperty keyProperty, SerializedProperty valueProperty, string keyLabel,
            string valueLabel, Rect linePosition) {
        ...
        static void SaveProperty(SerializedProperty keyProperty, SerializedProperty valueProperty, int index, int otherIndex,
